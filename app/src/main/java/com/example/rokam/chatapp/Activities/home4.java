...
public class home4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_content = (EditText)findViewById(R.id.txtPost4);
        edit_title = (EditText)findViewById(R.id.Name4);
        btn_post = (Button)findViewById(R.id.send4);
        recyclerView = (RecyclerView)findViewById(R.id.RecyclerView4);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("MATH 231");
