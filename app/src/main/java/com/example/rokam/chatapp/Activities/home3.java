...
public class home3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home3);edit_content = (EditText)findViewById(R.id.txtPost3);
        edit_title = (EditText)findViewById(R.id.Name3);
        btn_post = (Button)findViewById(R.id.send3);
        recyclerView = (RecyclerView)findViewById(R.id.RecyclerView3);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("CHEM 102");
